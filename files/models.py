...
class DocumentFolder(models.Model):
    ...
    user = models.ForeignKey(User, on_delete=models.CASCADE, related_name='document_folders')
...
class FileUpload(models.Model):
    ...
    folder = models.ForeignKey(DocumentFolder, on_delete=models.SET_NULL, null=True, blank=True, related_name='files') # CORRIGIDO
...
class PDFTemplate(models.Model):
    ...
    user = models.ForeignKey(User, on_delete=models.CASCADE, related_name='pdf_templates')
...
class GeneratedPDF(models.Model):
    ...
    user = models.ForeignKey(User, on_delete=models.CASCADE, related_name='generated_pdfs')
